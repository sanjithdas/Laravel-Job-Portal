...
Vue.component('password-reset-component', require('./components/PasswordResetComponent.vue').default);
Vue.component('email-reset-component', require('./components/EmailResetComponent.vue').default);
