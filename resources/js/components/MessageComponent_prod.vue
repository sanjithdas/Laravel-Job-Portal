<template>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-sm-12 cols mt-5 ml-0" style="border:0px solid green; margin-left:0px">
        ...
        methods:{
           ...
           hideModal() {
            ...
            sendMessage: function(){
                ...
                axios.post('jobs/chat/broadcast',{
            ...
            // Sending private messages 
               ...
               //  alert(this.private_message);
                axios.post('jobs/chat/private-message',{
            ...
            getSessionMessages: function(){
                axios.post('jobs/getSessionMessages', {
